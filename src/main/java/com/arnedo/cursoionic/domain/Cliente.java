...
public class Cliente implements Serializable {
	...
	@Column (unique = true) //porem vem uma exceção do spring data do banco
	...
	// o set não permite telefone repetido
	@ElementCollection //para entidade fraca
	@CollectionTable (name = "TELEFONE") //entidade auxiliar para gravar os telefones
